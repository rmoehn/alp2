...
def change_money_rec(amount, coins=COINS):
    ...
    if coins[0] <= amount:
        # Put the coin into the list of returned coins and proceed with the
        # remaining money
        return [ coins[0] ] + change_money_rec( amount - coins[0], coins )
    ...
    if coins[0] > amount:
        ...
        return change_money_rec(amount, coins)
